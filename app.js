...
const refs = {
  ...
  lightboxOverlyEl: document.querySelector(".lightbox__overlay"),
...
const galleryMarkup = createGallleryCardsMarkup(galleryItems);


refs.galleryContainer.insertAdjacentHTML("beforeend", galleryMarkup);
refs.galleryContainer.addEventListener('click', onOpenModal);
refs.lightboxButtonEl.addEventListener('click', onCloseModal);
window.addEventListener('keydown', onEscapeModalClose);
refs.lightboxOverlyEl.addEventListener('click', onOverlayModalClose);


function createGallleryCardsMarkup(galleryItems) {
